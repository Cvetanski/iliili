                    ...
                    <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($orders as $order)
                            @php
                                ...
                                $deliveries=DB::table('delivery')->select('type')->where('id',$order->delivery_id)->get();
                                $paymentMethods=DB::table('payment_methods')->select('method')->where('id',$order->paymenth_methods_id)->get();
                            @endphp
                            <tr>
                                <td>{{$order->id}}</td>
                                <td>{{$order->address}}</td>
