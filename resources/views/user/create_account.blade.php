                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <p>Тука може да го започнете вашето ново патување
                                во светот на книгите, одбери ја твојата совршена книга!</p>
                            <a href="{{asset('create-account')}}" class="btn_3">Креирај профил</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="{{asset('create-account')}}" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control" id="surname" name="surname" value=""
                                           placeholder="Презиме">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="emial" name="email" value=""
